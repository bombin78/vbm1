<template>
  ...
  <section class="page">
    <h2 class="page__content-title content-title">Изготовление новых машин МС-1Г.2</h2>

  	<h3 class="page__title">Машина на железнодорожном ходу для вибропогружения железобетонных свай и фундаментов опор контактной сети</h3>

  	<table class="page__table-photo table-photo blueimp-links">
  		<tbody>
